 ...
 */
public class NewJsonLongDoubleFloatDoubleVertexInputFormat extends
    ...
    class JsonLongDoubleFloatDoubleVertexReader extends
        ...
        @Override
        protected LongWritable getId(JSONArray jsonVertex) throws Exception,
                IOException {
            return new LongWritable(jsonVertex.getLong(0));
        }

        @Override
        protected Text getValue(JSONArray jsonVertex) throws
                Exception {
            return new Text(String.valueOf(jsonVertex.getDouble(1)));
        }
        ...
        protected Vertex<LongWritable, Text, NullWritable,
                Text> handleException(Text line, JSONArray jsonVertex,
                                      Exception e) {
