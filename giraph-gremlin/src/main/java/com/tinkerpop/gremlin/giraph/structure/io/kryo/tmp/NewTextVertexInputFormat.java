...
public abstract class NewTextVertexInputFormat<I extends WritableComparable,
    ...
    public abstract class
         ...
         * @throws java.io.IOException exception that can be thrown while reading
         */
         ...
         * @throws X           exception that can be thrown while reading the preprocessed
         *                     object
         * @throws java.io.IOException exception that can be thrown while reading
         */
         ...
         * @param processed the object obtained by preprocessing the line. Can be null if
